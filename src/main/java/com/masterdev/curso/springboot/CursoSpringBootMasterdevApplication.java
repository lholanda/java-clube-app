...
// anotacao para o JPA
@EnableJpaAuditing // habilita a auditoria do JPA para preencher automaticamente os campos createdAt e updatedAt
...
// // dotenv.entries().forEach(entry -> System.out.println("Variable: " + entry.getKey() + " = " + entry.getValue()));
